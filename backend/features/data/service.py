...
# -------------------------------
def generate_textbook_intervals(values, class_interval):
    """
...
def process_data(values, class_interval):
    ...
    intervals, boundaries, widths = generate_textbook_intervals(values, class_interval)
    
    # Step 2: Frequencies, midpoints, fixi
    frequencies, midpoints, fixis = calculate_frequencies(values, intervals)
    ...
    median = calculate_median(intervals, frequencies, cumulative_frequencies, total_frequencies, class_interval)
    mode = calculate_mode(intervals, frequencies, class_interval)
